...
function psc_post_slider_carousel_load_styles_and_js() {
    ...
    if (!is_admin()) {
        ...
        wp_register_style('p_s_c_bx', plugins_url('/css/p_s_c_bx.css', __FILE__),array(),'1.0.12');
        ...
        wp_register_script('p_s_c_bx', plugins_url('/js/p_s_c_bx.js', __FILE__),array('jquery'),'1.0.12');
        wp_register_script('psc_grid_min', plugins_url('/js/psc_grid_min.js', __FILE__),array('jquery'),'1.0.12');
