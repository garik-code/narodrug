               ...
               Sabai_Addon_System_IAdminSettings
{
    ...
    public function systemGetAdminRoutes()
    {
        return array(
            ...
            '/settings/file/regenerate_images' => array(
                'controller' => 'RegenerateImages',
                'callback_path' => 'regenerate_images',
                'title_callback' => true,
            ),
        );
    }
    ...
    public function systemGetAdminRouteTitle(Sabai_Context $context, $path, $title, $titleType, array $route)
    {
        switch ($path) {
            case 'regenerate_images':
                return __('Regenerate Images', 'sabai');
        }
    }
    ...
    public function onSystemAdminAddonLinksFilter(&$links, $addonName)
    {
        if ($addonName !== $this->_name) return;

        $links[] = $this->_application->LinkTo(
            '',
            $this->_application->Url('/settings/file/regenerate_images'),
            array('icon' => 'image'),
            array('class' => 'sabai-btn-default', 'title' => __('Regenerate Images', 'sabai'))
        );
    }
