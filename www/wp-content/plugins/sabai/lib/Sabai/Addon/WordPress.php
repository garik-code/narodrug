...
{
    const VERSION = '1.4.9', PACKAGE = 'sabai';
    ...
    public function onSabaiWebResponseRenderContentAdminAddPost($context, $template)
    {
        $context->addTemplate('wordpress_admin_content_post');
    }
        
    public function onSabaiWebResponseRenderContentAdminAddChildPost($context, $template)
    {
        $context->addTemplate('wordpress_admin_content_post');
    }
    
    public function onSabaiWebResponseRenderContentAdminEditPost($context, $template)
    {
        $context->addTemplate('wordpress_admin_content_post');
    }
        
    public function onSabaiWebResponseRenderContentAdminEditChildPost($context, $template)
    {
        $context->addTemplate('wordpress_admin_content_post');
    }
    
    public function onSabaiWebResponseRenderTaxonomyAdminAddTerm($context, $template)
    {
        $context->addTemplate('wordpress_admin_taxonomy_term');
    }
    
    public function onSabaiWebResponseRenderTaxonomyAdminEditTerm($context, $template)
    {
        $context->addTemplate('wordpress_admin_taxonomy_term');
    }
    ...
    public function addBodyClass($classes)
    {
        if (isset($GLOBALS['sabai_entity'])) {        
            ...
            if ($featured = $GLOBALS['sabai_entity']->isFeatured()) {
                $classes[] = 'sabai-entity-featured sabai-entity-featured-' . $featured; 
            }
        }
        return $classes;
    }
