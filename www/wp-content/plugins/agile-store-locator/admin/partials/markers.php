          ...
          <?php endif; ?>
            <div class="row">
              <div class="col-md-12 ralign">
                ...
                <button type="button" id="btn-asl-new-c" class="btn btn-primary mrg-r-10"><i><svg width="13" height="13"><use xlink:href="#i-plus"></use></svg></i><?php echo __('New Marker','asl_admin') ?></button>
              </div>
            </div>
            <div class="col-sm-12">
    ...
    <div class="smodal-content">
      ...
      <div class="smodal-body">
          ...
          <div class="col-md-12 form-group mb-3" style="display:none" id="updatemarker_editimage">                  
            <div class="input-group" id="drop-zone">
              ...
              <div class="custom-file">
                <input type="file" accept=".jpg,.png,.jpeg,.gif,.JPG" class="btn btn-default" name="files" id="file-logo-1" />
        ...
        <div class="smodal-footer">
          <button class="btn btn-primary btn-start mrg-r-15" id="btn-asl-update-markers"   type="button" data-loading-text="<?php echo __('Submitting ...','asl_admin') ?>"><?php echo __('Update Marker','asl_admin') ?></button>
