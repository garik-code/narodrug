        ...
        <div class="card p-0 mb-4">
          ...
          <div class="card-body">
            <?php if(!is_writable(ASL_PLUGIN_PATH.'public/svg')): ?>
              <h3  class="alert alert-danger" style="font-size: 14px"><?php echo ASL_PLUGIN_PATH.'public/svg' ?> <= <?php echo __('Directory is not writable, Category Image Upload will Fail, Make directory writable.','asl_admin') ?></h3>  
            <?php endif; ?>
            <div class="row">
