                ...
                <div class="card p-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-md-3">
                                <button class="btn btn-sm btn-danger" type="button" id="asl-delete-shape"><span style="margin-right:10px;font-size:12px" class="glyphicon glyphicon-trash"></span><span><?php echo __('Delete','asl_admin') ?></span></button>
                                <button class="btn btn-sm btn-warning" type="button" id="asl-clear-all"><span><?php echo __('Clear All','asl_admin') ?></span></button>
                            </div>
                            <div class="col-md-7">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" id="asl-save-map" data-loading-text="<?php echo __('Saving...','asl_admin') ?>" class="float-right btn btn-primary"><?php echo __('Save Customization','asl_admin') ?></button>
                            </div>
                        </div>
                    </div>
                </div>
