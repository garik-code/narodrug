              ...
              <form id="frm-addstore">
                  ...
                  <div class="row">
                  	<div class="col-md-6 form-group mb-3">
                    	<div class="form-group">
											  <label for="ddl-asl-markers"><?php echo __('Marker','asl_admin') ?></label>
											    ...
											    <button type="button" class="btn btn-success" data-toggle="smodal" data-target="#addmarkermodel"><?php echo __('New Marker','asl_admin') ?></button>
											    </div>
											</div>
                    </div>
                    ...
                    <div class="col-md-6 form-group mb-3">
										  ...
										  <div class="input-group">
										    <select id="ddl-asl-logos">
											  ...
											  <button type="button" class="btn btn-success" data-toggle="smodal" data-target="#addimagemodel"><?php echo __('New Logo','asl_admin') ?></button>
										  </div>
										</div>
										<div class="col-md-6 form-group mb-3">
                    ...
                    <div class="col-md-6 form-group mb-3">
                      ...
                      <small class="form-text text-muted"><?php echo __('Descending Order for the list, higher number on top.','asl_admin') ?>, Shortcode [ASL_STORELOCATOR sort_by="ordr"]</small>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                  ...
                  <div class="card-title mt-3 mb-3"><?php echo __('Store Timing','asl_admin') ?></div>
                  <?php
                  ...
                  <div class="row">
                  	<div class="col-12 mt-3">
                  		<button type="button" class="float-right btn btn-primary mrg-r-10" data-loading-text="<?php echo __('Saving Store...','asl_admin') ?>" data-completed-text="<?php echo __('Store Saved','asl_admin') ?>" id="btn-asl-add"><?php echo __('Add Store','asl_admin') ?></button>
                  	</div>
                  </div>
              </form>
          </div>
