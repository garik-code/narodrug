...
<div class="asl-p-cont asl-new-bg">
  <div class="hide">
    <svg xmlns="http://www.w3.org/2000/svg">
      <symbol id="i-cart" viewBox="0 0 32 32" width="32" height="32" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
          <path d="M6 6 L30 6 27 19 9 19 M27 23 L10 23 5 2 2 2" />
          <circle cx="25" cy="27" r="2" />
          <circle cx="12" cy="27" r="2" />
      </symbol>
      <symbol id="i-tag" viewBox="0 0 32 32" width="32" height="32" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
        <circle cx="24" cy="8" r="2" />
        <path d="M2 18 L18 2 30 2 30 14 14 30 Z" />
      </symbol>
      <symbol id="i-location" viewBox="0 0 32 32" width="32" height="32" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
          <circle cx="16" cy="11" r="4" />
          <path d="M24 15 C21 22 16 30 16 30 16 30 11 22 8 15 5 8 10 2 16 2 22 2 27 8 24 15 Z" />
      </symbol>
      <symbol id="i-search" viewBox="0 0 32 32" width="32" height="32" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
      ...
      <div class="col-md-12">
        <div class="card p-0 mb-4">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-sm btn-success pull-right" data-toggle="smodal" data-target="#import_assets_model"><?php echo __('Import Assets Zip','asl_admin') ?></button>
            </h3>
                ...
                <div class="tab-pane" role="tabpanel" id="asl-views" aria-labelledby="asl-views">
                  ...
                  <div class="col-md-12"> 
                    <ul class="list-group">
                      ...
                      <li class="list-group-item">
                        <div class="row">
                          <div class="col-2 store-id"><?php echo $s->store_id ?></div>
                          <div class="col-8"><?php echo $s->title ?></div>
                          <div class="col-2"><?php echo $s->views ?></div>
                        </div>
                      </li>
                      <?php endforeach; ?>
                    </ul>
                  ...
                  <div class="col-md-12"> 
                    <ul class="list-group">
                      ...
                      <li class="list-group-item">
                        <div class="row">
                          <div class="col-8"><?php echo $s->search_str ?></div>
                          <div class="col-4"><?php echo $s->views ?></div>
                        </div>
                      <?php endforeach; ?>
                    </ul>
                  </div>
