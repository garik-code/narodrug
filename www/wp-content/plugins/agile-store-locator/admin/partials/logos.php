          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12 ralign">
                ...
                <button type="button" id="btn-asl-new-c" class="btn btn-primary mrg-r-10"><i><svg width="13" height="13"><use xlink:href="#i-plus"></use></svg></i><?php echo __('New Logo','asl_admin') ?></button>
              </div>
            </div>
      ...
      <div class="smodal-content">
        ...
        <div class="smodal-body">
          ...
          <div class="smodal-footer">
            <button class="btn btn-primary btn-start mrg-r-15" id="btn-asl-update-logos"   type="button" data-loading-text="<?php echo __('Submitting ...','asl_admin') ?>"><?php echo __('Update Logo','asl_admin') ?></button>
