...
{site_url}', 'sabai-paidlistings'),
    ...
    {
        require_once SABAI_PACKAGE_PAIDLISTINGS_PATH . '/lib/PaidListings/CSV/Exporter.php';
        return new Sabai_Addon_PaidListings_CSV_Exporter($this->_application, $name);
    }
    ...
    {
        require_once SABAI_PACKAGE_PAIDLISTINGS_PATH . '/lib/PaidListings/CSV/Importer.php';
        return new Sabai_Addon_PaidListings_CSV_Importer($this->_application, $name);
    }
}